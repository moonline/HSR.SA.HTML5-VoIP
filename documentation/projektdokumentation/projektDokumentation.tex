...
\providecommand{\versionnumber}{1.11}
...
\begin{tabularx}{\textwidth}{|cXlr|} % Versionstabelle, Rahmen links und rechts
		...
		\versionnumber & Rechtschreibkorrektur, Austausch Bilder, Überarbeitung Qualitymanagement & Jannis Grimm, Tobias Blaser & 18.12.13\\
		\hline
\end{tabularx}
...
\input{../architekturanalayse/thirdPartyCode}
